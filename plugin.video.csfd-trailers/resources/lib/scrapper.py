...
def _plot(page):
	...
	if m:
		p = re.sub('</li>','[CR]',m,flags=re.IGNORECASE)
		p = re.sub('<br[^>]*>','[CR]',p,flags=re.IGNORECASE)
		p = re.sub('<(li|div|span)[^>]*>','',p,flags=re.IGNORECASE)
		p = re.sub('</div>|</span>','',p,flags=re.IGNORECASE)
		p = re.sub('<a[^>]*>','[B]',p,flags=re.IGNORECASE)
		p = re.sub('</a>','[/B]',p,flags=re.IGNORECASE)
		p = re.sub('<em>','[I]',p,flags=re.IGNORECASE)
		p = re.sub('</em>','[/I]',p,flags=re.IGNORECASE)
		p = re.sub('<strong>','[B]',p,flags=re.IGNORECASE)
		p = re.sub('</strong>','[/B]',p,flags=re.IGNORECASE)
		p = re.sub('<img[^>]+>','',p,flags=re.IGNORECASE)
